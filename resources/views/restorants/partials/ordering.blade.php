@if(!config('settings.makePureSaaS',false)  && !(config('app.isdrive',false)||config('app.issd',false)) )
    @if(config('app.ordering'))
        ...
        @include('partials.fields',['fields'=>[
            ...
            ['required'=>true,'ftype'=>'select','placeholder'=>"Auto Confirm Order",'name'=>'Auto Confirm Order', 'id'=>'auto_confirm_order','data'=>[0=>'No',1=>'Yes'],'value'=>$restorant->order_auto_accept]
        ]])
    @endif
@endif